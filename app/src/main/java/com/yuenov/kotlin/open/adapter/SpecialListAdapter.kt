...
class SpecialListAdapter :
    BaseQuickAdapter<SpecialInfoItem, BaseViewHolder>(R.layout.view_adapter_find_item) {

    private var listener: IBookBlItemAdapter? = null

    override fun convert(holder: BaseViewHolder, item: SpecialInfoItem) {
        holder.setText(R.id.tvAblCategoryName, item.name)
    ...
    interface IBookBlItemAdapter {
        ...
        fun onBookBlItemAdapterShowAll(special: SpecialInfoItem)
        fun onBookBlItemAdapterReplace(special: SpecialInfoItem)
    }
